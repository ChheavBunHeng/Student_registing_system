...
function Office() {
    return (
        ...
        <div className="Card w-[300px] h-[350px] border flex flex-col flex-wrap hover:shadow-lg duration-300 ease-in-out">
    ...
    <div className="flex justify-center Card-Content m-[10px] gap-[10px]">
        <div className="flex flex-row justify-around w-[250px]">
            <h1 className="px-[10px] text-center text-xl font-semibold bg-yellow-100 text-blue-400 font-bold">Design</h1>
